...
public class Lesson2 {
    ...
    public static void main (String [] args){
        ...
        WebDriver driver = lesson2.initChrome();
        driver.get("http://prestashop-automation.qatestlab.com.ua/admin147ajyvk0/");
        lesson2.enterPassword (driver, "webinar.test@gmail.com", "Xcg7299bnSmMuRLp9ITw");
        lesson2.threadSleep(3000);
        ...
        for (String menuName : menuLinksArray) {
            ...
            etalonTitle = lesson2.clickMenueAndGetTitle(driver, menuName, changingTitleName);
            driver.navigate().refresh();
            lesson2.threadSleep(1000);
            afterRefreshTitle = lesson2.getOnlyTitle(driver, changingTitleName);
...
/*        URL url = Lesson2.class.getResource ("chromedriver.exe");
        System.setProperty("webdriver.chrome.driver",url.getFile());
        */
        System.setProperty("webdriver.chrome.driver",
                new File(Lesson2.class.getResource("chromedriver.exe").getFile()).getPath());
